...
class Registros(models.Model):
    ...
    horas=models.PositiveSmallIntegerField(u'vou estar no ponto às',choices=HORAS,default=7,help_text='você receberá um twitter 30 minutos antes com o horário do seu ônibus.')
